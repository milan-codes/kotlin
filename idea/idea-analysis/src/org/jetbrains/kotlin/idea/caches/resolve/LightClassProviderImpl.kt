...
class LightClassProviderImpl : LightClassProvider {
    ...
    override fun checkElementIsFacadeClass(element: PsiElement): Boolean = element is KtLightClassForFacade
    override fun getUnwrappedElement(element: PsiElement): PsiElement? = element.unwrapped
